...
import { View, Text, StyleSheet, ImageBackground, ScrollView, Modal, Dimensions, FlatList } from 'react-native';
  ...
  return (
    <View style={[styles.container, { backgroundColor: userId ? ProfileInfo?.theme : editProfile?.theme ? editProfile?.theme : theme.colors.light }]}>
      ...
      <View
        ...
        <View style={{
          // profile container
          width: '100%', height: '100%', backgroundColor: userId ? ProfileInfo?.theme : editProfile?.theme ? editProfile?.theme : theme.colors.light,
          paddingVertical: 20,
          ...
          <View style={{
            ...
            paddingBottom: 10, gap: 10, paddingHorizontal: 20
          }}>
                      ...
                      AllMemos.length > 0 ?
                        <View style={{ justifyContent: 'center' }}>
                          <FlatList
                            ...
                            renderItem={({ item }) => (
                              <View style={{
                                width: width / 2 - 10, backgroundColor: theme.colors.light,
                                flexDirection: 'row', justifyContent: 'space-between', alignItems: 'center',
                                margin: 5, borderWidth: 0.17, borderColor: theme.colors.dark, borderRadius: 10
                              }}>
                                <Text style={{
                                  fontSize: fontSizes.large, fontWeight: fontWeights.normal, lineHeight: 30, padding: 10
                                }}>{item.memo}</Text>
                              </View>
                            )}
